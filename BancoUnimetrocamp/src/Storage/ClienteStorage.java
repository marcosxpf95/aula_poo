...
public class ClienteStorage {
	...
	public Cliente getClienteStoraged() {
		...
		try {
			...
			Endereco endereco = new Endereco(dadosCliente[3], dadosCliente[4], dadosCliente[5], dadosCliente[6],
					dadosCliente[7], Integer.parseInt(dadosCliente[8]), dadosCliente[9]);

			Conta conta = new Conta(formato.parse(dadosCliente[12]), dadosCliente[13],
					Double.parseDouble(dadosCliente[14]), Double.parseDouble(dadosCliente[15]));

			Cartao cartao = new Cartao(dadosCliente[16], Integer.parseInt(dadosCliente[17]),
					Double.parseDouble(dadosCliente[18]));

			Cliente cliente = new Cliente(dadosCliente[0], dadosCliente[1], dadosCliente[2], endereco, dadosCliente[10],
					Integer.parseInt(dadosCliente[11]), conta, cartao);
